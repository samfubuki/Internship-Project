...
<body style="background: cyan">
   <h1>Bill Charge Group Registration Form</h1>
   <form:form action="savebillchargegroup" modelAttribute="BillChargeGroup"
    ...
    <div class="col-md-4">
    Bill Charge Sr No:<form:input path="srno" id="srno" />
    </div>
...
<script type="text/javascript">
  function validateForm(){
	  ...
	  if (billchargegroupname.length < 1) {
			...
			alert("Please enter the Bill Charge Sr No name with length greater than 1");
			return false;
	  }else {
			return true;
		}
